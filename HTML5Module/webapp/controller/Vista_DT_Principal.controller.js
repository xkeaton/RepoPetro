sap.ui.define([
	...
	return Controller.extend("namespace.HTML5Module.controller.Vista_DT_Principal", {

		oGlobalFecha: "",

		onInit: function () {

			this.getRouter().getRoute("Vista_DT_Principal").attachMatched(this._onRouteMatched, this);
		...
		onPressRegistrarOrden1: function () {
			...
			this.getView().byId("id Seccion13").setIcon("sap-icon://overlay");
        ...
        handleUrlPress: function () {
			var texto = "test";
			URLHelper.redirect("https://wa.me/send?text=Hola%2C%20acabo%20de%20notificarte"+texto, true);
		},
		handleemailPress: function () {
			var texto2 = "test2";
			URLHelper.triggerEmail("xgrant_zk@hotmail.com", "Hola esto es prueba","este es el cuerpo de pruebas");
        },
        handleSelectMenuItemProgramarpedido: function () {

			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.navTo("Vista_DT_Cita");
		}
	});
});